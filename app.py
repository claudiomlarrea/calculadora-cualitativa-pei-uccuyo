        ...
        if st.button("🔍 Realizar análisis por objetivo (1 a 6)"):
            with st.spinner("Analizando columna por columna..."):
                for col in columnas_actividades:
                    ...
                    if textos_filtrados:
                        prompt_columna = (
                            f"Realiza un análisis temático y del discurso profundo de las expresiones en la columna '{col}'. "
                            f"Organiza el análisis en dos partes:\n\n"
                            f"1. ANÁLISIS TEMÁTICO:\n"
                            f"- Temas y subtemas emergentes.\n"
                            f"- Códigos frecuentes y significativos.\n"
                            f"- Patrones de sentido y preocupaciones comunes.\n\n"
                            f"2. ANÁLISIS DEL DISCURSO:\n"
                            f"- Actos de habla, relaciones de poder, tono e ideología.\n"
                            f"- Posicionamientos institucionales.\n"
                            f"- Modalidades del lenguaje y sentido implícito.\n\n"
